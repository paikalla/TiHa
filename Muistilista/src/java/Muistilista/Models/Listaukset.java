...
//Etsii yhden askareen.
    public List<Askareet> etsiAskare() {
        PreparedStatement kysely = null;
        ResultSet rs = null;
        ...
        ArrayList<Askareet> etsi = new ArrayList(); 
        try {
        kysely = yhteys.prepareStatement("SELECT * FROM Askare WHERE AskareID = ?");
        ...
        while (rs.next()){
            ...
            Askareet a = new Askareet();
            a.setAskareNimi(askareNimi);
